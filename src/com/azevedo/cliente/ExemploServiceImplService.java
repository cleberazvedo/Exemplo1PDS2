 ...
 * 
 */
@WebServiceClient(name = "ExemploServiceImplService", targetNamespace = "http://azevedo.com/", wsdlLocation = "http://localhost:8080/exemplo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXEMPLOSERVICEIMPLSERVICE_QNAME = new QName("http://azevedo.com/", "ExemploServiceImplService");
    ...
    public ExemploService getExemploServiceImplPort() {
        return super.getPort(new QName("http://azevedo.com/", "ExemploServiceImplPort"), ExemploService.class);
    }
    ...
    public ExemploService getExemploServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://azevedo.com/", "ExemploServiceImplPort"), ExemploService.class, features);
    }
